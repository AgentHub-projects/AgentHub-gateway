...
type SessionManager interface {
	...
	ConnectWorker(ctx context.Context, sessionID acp.SessionID, agentID session.AgentID, agentSelector string) (*acp.ClientSideConnection, error)
}
...
type SessionCreator interface {
	...
	PrepareSandbox(ctx context.Context, sessionID acp.SessionID, sandboxSelector string) error
	ConnectLeader(ctx context.Context, sessionID acp.SessionID, agentID session.AgentID, agentSelector string) (*acp.ClientSideConnection, error)
	List() []acp.SessionID
}
